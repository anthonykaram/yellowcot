...
INCPATH = -I/usr/share/qt/mkspecs/linux-g++-$(LBITS) -I. -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtGui -I/usr/include/qt4 -I. -I.
LINK = g++
...
yellowcot:
	...
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) $@.h -o moc_$@.cpp
